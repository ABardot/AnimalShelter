...
namespace AnimalShelterApp.Controllers
{
    public class AdoptionsController : Controller
    {
        ...
        {
            var adoptions = db.Adoptions.Include(a => a.Family).Include(a => a.Pet);
        ...
        {
            ViewBag.FamilyID = new SelectList(db.Families, "FamilyID", "HasSmallChildren");
            ViewBag.PetID = new SelectList(db.Pets, "PetID", "Type");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "AdoptionID,PetID,FamilyID,DateAdopted,EmployeeName")] Adoption adoption)
        {
            ...
            ViewBag.FamilyID = new SelectList(db.Families, "FamilyID", "HasSmallChildren", adoption.FamilyID);
            ViewBag.PetID = new SelectList(db.Pets, "PetID", "Type", adoption.PetID);
            return View(adoption);
        }
